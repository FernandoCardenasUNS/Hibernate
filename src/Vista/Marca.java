...
public class Marca extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tablamarca.setFont(new java.awt.Font("Cambria Math", 1, 14)); // NOI18N
    ...
    public void Insertar(){
        try {
            String SQL="INSERT INTO marca(id_marca,descripcion)values(?,?)";
    ...
    public void Actualizar(){
        try {
            String SQL="UPDATE marca SET id_marca=?,descripcion=? WHERE id_marca=?";
            int filaSeleccionada=tablamarca.getSelectedRow();
            String dao=(String)tablamarca.getValueAt(filaSeleccionada,0);
            PreparedStatement pst=con.prepareStatement(SQL);
            pst.setString(1, txtid.getText());
            pst.setString(2, txtdes.getText());
            pst.setString(3,dao);
    ...
    public void Filtrar(String valor){
        ...
        String[] registro=new String[3];
        DefaultTableModel modelo= new DefaultTableModel(null,titulo);
        String SQL="SELECT * FROM marca WHERE descripcion like '%"+valor+"%'";
        try {
            Statement st= con.createStatement();
            ResultSet rs= st.executeQuery(SQL);
            while (rs.next()) {
    ...
    public void Eliminar(){
        int filaSeleccionada=tablamarca.getSelectedRow();
        try {
            String SQL="DELETE FROM marca WHERE id_marca="+tablamarca.getValueAt(filaSeleccionada,0);
            Statement st=con.createStatement();
    ...
    private void tablamarcaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablamarcaMouseClicked
        int filaSeleccionada=tablamarca.rowAtPoint(evt.getPoint());
        txtid.setText(tablamarca.getValueAt(filaSeleccionada,0).toString());
        txtdes.setText(tablamarca.getValueAt(filaSeleccionada,1).toString());
