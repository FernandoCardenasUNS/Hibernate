...
public class Presentacion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tablapresentacion.setFont(new java.awt.Font("Cambria Math", 1, 14)); // NOI18N
        ...
        txtb.setFont(new java.awt.Font("Cambria Math", 1, 14)); // NOI18N
        ...
        jLabel1.setText("ID_Presentacion");
        ...
        txtdes.setFont(new java.awt.Font("Cambria Math", 1, 14)); // NOI18N
    ...
    public void Insertar(){
        try {
            String SQL="INSERT INTO presentacion(id_presentacion,descripcion)values(?,?)";
    ...
    public void Actualizar(){
        try {
            String SQL="UPDATE presentacion SET id_presentacion=?,descripcion=? WHERE id_presentacion=?";
            int filaSeleccionada=tablapresentacion.getSelectedRow();
            String dao=(String)tablapresentacion.getValueAt(filaSeleccionada,0);
            PreparedStatement pst=con.prepareStatement(SQL);
            pst.setString(1, txtid.getText());
            pst.setString(2, txtdes.getText());
            pst.setString(3,dao);
    ...
    public void Mostrar(){
        ...
        try {
            ...
            tablapresentacion.setModel(modelo);
        } catch (Exception e) {
    ...
    public void Filtrar(String valor){
        ...
        String[] registro=new String[3];
        DefaultTableModel modelo= new DefaultTableModel(null,titulo);
        String SQL="SELECT * FROM presentacion WHERE descripcion like '%"+valor+"%'";
        try {
            Statement st= con.createStatement();
            ResultSet rs= st.executeQuery(SQL);
            while (rs.next()) {
    ...
    public void Eliminar(){
        int filaSeleccionada=tablapresentacion.getSelectedRow();
        try {
            String SQL="DELETE FROM presentacion WHERE id_presentacion="+tablapresentacion.getValueAt(filaSeleccionada,0);
            Statement st=con.createStatement();
    ...
    private void tablapresentacionMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablapresentacionMouseClicked
        int filaSeleccionada=tablapresentacion.rowAtPoint(evt.getPoint());
        txtid.setText(tablapresentacion.getValueAt(filaSeleccionada,0).toString());
        txtdes.setText(tablapresentacion.getValueAt(filaSeleccionada,1).toString());
